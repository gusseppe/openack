...
class Estados extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tipo, referencia, descripcion', 'required'),
			array('referencia', 'numerical', 'integerOnly'=>true),
			array('tipo, descripcion', 'length', 'max'=>25),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, tipo, referencia, descripcion', 'safe', 'on'=>'search'),
		);
	}
