 ...
 * @property integer $NumeroDeAportes
 */
class Tema extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('NumeroDeAportes', 'numerical', 'integerOnly'=>true),
			array('Nombre', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idTema, Nombre, NumeroDeAportes', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'idTema' => 'Id Tema',
			'Nombre' => 'Nombre',
			'NumeroDeAportes' => 'Numero De Aportes',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('NumeroDeAportes',$this->NumeroDeAportes);
